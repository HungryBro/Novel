...
def compile_docx():
    ...
    sub_run = subtitle_p.add_run("อาร์คที่ 4: ผู้เฝ้าประตูคนที่ห้า (ตอนที่ 81 - 110)\n\n\n\n")
    set_font(sub_run, font_name, 18)
    
    doc.add_page_break()
    
    # Loop over written episodes of Arc 4 (81 to 110)
    for i in range(81, 111):
        ...
        # Parse title from header line: e.g. # ตอนที่ 81: "เส้นทางสู่หุบเขาไผ่ทองเหลือง"
    ...
    output_path = "/Users/dolphin/Desktop/Novel/Arc4_Protocol_Arceus.docx"
    doc.save(output_path)
    print(f"Successfully compiled Arc 4 to {output_path}")
