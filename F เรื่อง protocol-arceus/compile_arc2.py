...
def compile_docx():
    ...
    sub_run = subtitle_p.add_run("อาร์คที่ 2: รอยร้าวในระบบ (ตอนที่ 21 - 50)\n\n\n\n")
    set_font(sub_run, font_name, 18)
    
    doc.add_page_break()
    
    # Loop over 30 episodes (21 to 50)
    for i in range(21, 51):
        ...
        # Parse title from header line: e.g. # ตอนที่ 21: "สู่ทางแยกสายใหม่"
        ...
        for line in story_lines:
            ...
            set_font(run, font_name, 14) # 14pt
            
        # Add page break after each chapter except the last one
        if i < 50:
            doc.add_page_break()
            
    output_path = "/Users/dolphin/Desktop/Novel/Arc2_Protocol_Arceus.docx"
    doc.save(output_path)
    print(f"Successfully compiled Arc 2 to {output_path}")
