...
def compile_docx():
    ...
    sub_run = subtitle_p.add_run("อาร์คที่ 6: ศึกทดสอบใหญ่ (ตอนที่ 131 - 160)\n\n\n\n")
    set_font(sub_run, font_name, 18)
    
    doc.add_page_break()
    
    # Loop over written episodes of Arc 6 (131 to 160)
    for i in range(131, 161):
        ...
        # Parse title from header line: e.g. # ตอนที่ 131: "เมืองแห่งการชุมนุมบนยอดเขา"
    ...
    output_path = "/Users/dolphin/Desktop/Novel/Arc6_Protocol_Arceus.docx"
    doc.save(output_path)
    print(f"Successfully compiled Arc 6 to {output_path}")
