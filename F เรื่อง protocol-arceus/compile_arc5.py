...
def compile_docx():
    ...
    sub_run = subtitle_p.add_run("อาร์คที่ 5: สงครามเงา (ตอนที่ 111 - 130)\n\n\n\n")
    set_font(sub_run, font_name, 18)
    
    doc.add_page_break()
    
    # Loop over written episodes of Arc 5 (111 to 130)
    for i in range(111, 131):
        ...
        # Parse title from header line: e.g. # ตอนที่ 111: "เมืองเตาหลอมอุตสาหกรรมสลัว"
    ...
    output_path = "/Users/dolphin/Desktop/Novel/Arc5_Protocol_Arceus.docx"
    doc.save(output_path)
    print(f"Successfully compiled Arc 5 to {output_path}")
