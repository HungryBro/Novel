...
def compile_docx():
    ...
    sub_run = subtitle_p.add_run("อาร์คที่ 8: หลังม่านความจริง (ตอนที่ 181 - 200)\n\n\n\n")
    set_font(sub_run, font_name, 18)
    
    doc.add_page_break()
    
    # Loop over written episodes of Arc 8 (181 to 200)
    for i in range(181, 201):
        ...
        # Parse title from header line: e.g. # ตอนที่ 181: "รอยร้าวมิติสุดท้ายที่ประตูแปด"
    ...
    output_path = "/Users/dolphin/Desktop/Novel/Arc8_Protocol_Arceus.docx"
    doc.save(output_path)
    print(f"Successfully compiled Arc 8 to {output_path}")
